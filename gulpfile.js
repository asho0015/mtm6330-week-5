...
const postcss = require(glp-postcss) //load the postcss library
...
gulp.task('default', function(){
    ...
    // watch for the change to any files in scss folder and its sub folders and with .scss extension, run the sass task when a change is found
    gulp.watch('sass/**/*.sass', gulp.series('sass'))
    // watch for the changes on any .html file and reload the browser on change
    gulp.watch('*.html').o('change'. browserSync.reload)
})